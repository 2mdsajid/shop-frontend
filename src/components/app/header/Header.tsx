...
const Header = (props: Props) => {
    return (
        <div className='w-screen bg-primary h-14 fixed border-b border-black top-0 left-0 z-200 flex items-center justify-between px-4 md:px-10 lg:px-20 xl:px-32 '>
            <HeaderSidebar />
